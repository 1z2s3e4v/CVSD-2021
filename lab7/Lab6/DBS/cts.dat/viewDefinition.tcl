...
create_analysis_view -name av_scan_mode_max -constraint_mode scan_mode -delay_corner Delay_Corner_max -latency_file ${::IMEX::libVar}/mmmc/latency.sdc
create_analysis_view -name av_scan_mode_min -constraint_mode scan_mode -delay_corner Delay_Corner_min -latency_file ${::IMEX::libVar}/mmmc/latency.sdc
